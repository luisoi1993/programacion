...
function generaTabla(){
	...
	for(var i=0;i<5;i++){
		...
		for(var j=0;j<5;j++){			
			...
			valor=aleatorio(0,4);
			nuevoinput=document.createElement("input");//forma adrian, mucho más limpia
			if(valor==0){
...
//la parte del randome se puede hacer con un Array
//var pulsado =e.target;
//var eqtiqueta = pulsado.tagName;
/*if etiqueta=="input" 
tipo=pulsado.type;
if(tipo==undefined)
	consolelog(no hay nada);
else
	consolelog(aqui hay + tipo);
*/